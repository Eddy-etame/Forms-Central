...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 p-5">
        <div className="mb-4 flex items-center gap-2 text-sm font-bold text-slate-900 dark:text-white"><Activity className="h-4 w-4 text-blue-500" /> Last 30 days</div>
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
        <div className="border-b border-slate-100 dark:border-slate-800 px-5 py-4 text-sm font-bold text-slate-900 dark:text-white">Recent visitors</div>
            ...
            <tbody className="divide-y divide-slate-50">
              {stats.recent.length === 0 ? (
                ...
                <tr key={i} className="hover:bg-slate-50">
                  ...
                  <td className="px-5 py-3 text-slate-600 dark:text-slate-400">{r.country || '—'}</td>
                </tr>
              ))}
            </tbody>
          </table>
