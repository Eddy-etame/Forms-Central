...
export const metadata: Metadata = {
  ...
  description:
    "How to integrate Inlet into any website: the two-value contract (FORM_API_URL + FORM_ID), the proof-of-work challenge, the submit endpoint, field conventions, and a copy-paste helper for Astro, Next.js, Vue or plain HTML.",
