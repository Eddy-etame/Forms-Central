...
export default function AiChat() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        aria-label={open ? 'Close assistant' : 'Ask the King E Forms assistant'}
      ...
      {open && (
        <div
          role="dialog"
          aria-label="King E Forms AI assistant"
        ...
        >
          ...
          <div className="flex items-center gap-3 border-b border-slate-100 bg-slate-950 px-5 py-4 text-white">
            ...
            <div>
              <p className="text-sm font-semibold leading-tight">King E Forms Assistant</p>
            ...
            {messages.length === 0 && !paywalled && (
              <div className="space-y-3">
                <div className="max-w-[85%] rounded-2xl rounded-tl-sm bg-slate-100 px-4 py-3 text-sm text-slate-800">
                  Hi! Ask me anything about King E Forms — integration, spam protection, plans.
                </div>
